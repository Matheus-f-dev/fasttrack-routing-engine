...
class VisitedHubResponse(BaseModel):
    id: UUID = Field(description="Hub unique identifier", examples=["3fa85f64-5717-4562-b3fc-2c963f66afa6"])
...
class RouteResponse(BaseModel):
    ...
    visited_hub: VisitedHubResponse | None = Field(
        default=None,
        description="Secondary hub visited during the route, if any",
    )
